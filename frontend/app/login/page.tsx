...
export default function LoginPage() {
  ...
  const [email, setEmail] = useState("superadmin@discover.app");
      ...
      <div className="grid gap-6 xl:grid-cols-[1fr_0.75fr]">
        <Card>
          ...
          <form onSubmit={login} className="space-y-4">
            <Input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="superadmin@discover.app" />
